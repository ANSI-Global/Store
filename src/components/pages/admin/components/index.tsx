              ...
              <MDBRow className="mt-3">
                ...
                <MDBCol md="7" col="7" className="text-right pr-5">
                  <h5 className="ml-4 mt-4 mb-2 font-weight-bold">
                    {data.server.getStatistics.users.uniquevisitors}{" "}
                  </h5>
          ...
          <MDBCol xl="3" md="6" className="mb-4 mb-r">
            <MDBCard>
              <MDBRow className="mt-3">
                ...
                <MDBCol md="7" col="7" className="text-right pr-5">
                  <h5 className="ml-4 mt-4 mb-2 font-weight-bold">
                    {data.server.getStatistics.users.newUsers}
                  </h5>
          ...
          <MDBCol xl="3" md="6" className="mb-4 mb-r">
            <MDBCard>
              <MDBRow className="mt-3">
                ...
                <MDBCol md="7" col="7" className="text-right pr-5">
                  <h5 className="ml-4 mt-4 mb-2 font-weight-bold">
                    {data.server.getStatistics.sales}
                  </h5>
          ...
          <MDBCol xl="3" md="6" className="mb-4 mb-r">
            <MDBCard>
              <MDBRow className="mt-3">
                ...
                <MDBCol md="7" col="7" className="text-right pr-5">
                  <h5 className="ml-4 mt-4 mb-2 font-weight-bold">
                    {data.server.getStatistics.orders}{" "}
                  </h5>
            ...
            <MDBCard>
              <MDBRow className="mt-4 mb-3">
                ...
                <MDBCol md="9" col="9" className="text-right pr-5">
                  ...
                  <h5 className="ml-4 mb-2 font-weight-bold">
                    {data.server.getStatistics.socialMedia.facebookUsers}{" "}
                  </h5>
                </MDBCol>
              </MDBRow>
            </MDBCard>
            ...
            <MDBCard className="mt-4">
              <MDBRow className="mt-4 mb-3">
                ...
                <MDBCol md="9" col="9" className="text-right pr-5">
                  ...
                  <h5 className="ml-4 mb-2 font-weight-bold">
                    {data.server.getStatistics.socialMedia.googleUsers}{" "}
                  </h5>
                </MDBCol>
              </MDBRow>
            </MDBCard>
            ...
            <MDBCard className="mt-4 mb-4">
              <MDBRow className="mt-4 mb-3">
                ...
                <MDBCol md="9" col="9" className="text-right pr-5">
                  ...
                  <h5 className="ml-4 mb-2 font-weight-bold">
                    {data.server.getStatistics.socialMedia.twitterUsers}{" "}
                  </h5>
                </MDBCol>
              </MDBRow>
            </MDBCard>
